...
public class PoliticianComparisonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- Swap Buttons (Click to change candidate) ---
        ...
        // --- Remove Buttons (Click to clear a slot) ---
    ...
    /**
     * Updates the UI for either the left or right card.
     */
    private void updateCard(boolean isLeft, Politician politician) {
        ...
        // 3. Set The Data Rows (Using the new layout logic)
    ...
    /**
     * Helper to set the title and text for a specific row.
     */
    private void setMetricRow(String side, int index, String label, String content) {
        // Find the included layout (e.g., metricLeft1)
