...
public class HomescreenViewModel extends AndroidViewModel {
    ...
    public HomescreenViewModel(Application application) {
        ...
        // 1. Initialize the main local data repository
        repository = new VoteInformed_Repository(application);

        // 2. Initialize LiveData from the main repository (Room Database)
        ...
        // 3. Initialize the Network Repository to handle fetching
        ...
        // 4. Trigger the network fetch and save to Room on startup
