...
public class InitialData {
    ...
    public static List<Politician> getPoliticians()
    {
        ...
        list.add(new Politician(
                ...
                "Democratic",
                "https://en.wikipedia.org/wiki/File:Alexandria_Ocasio-Cortez_Official_Portrait.jpg",
                "718-662-5970",
        ...
        list.add(new Politician(
                "Andrew Cuomo",
                "Democratic",
                "https://en.wikipedia.org/wiki/File:Governor_Andrew_Cuomo_in_2021.jpg",
                "518-474-8390",
        ...
        list.add(new Politician(
                "Curtis Sliwa",
                "Republican",
                "https://en.wikipedia.org/wiki/File:Curtis_Sliwa_23_Oct_2025_-_1.jpg",
        ...
        list.add(new Politician(
                "Zohran Mamdani",
                "Democratic",
                "https://en.wikipedia.org/wiki/File:Zohran_Mamdani_05.25.25_(b)_(cropped).jpg",
        ...
        list.add(new Politician(
                "Nick LaLota",
                "Republican",
                "https://en.wikipedia.org/wiki/File:Nick_lalota_portrait.jpg",
        ...
        list.add(new Politician(
                "Michael Gianaris",
                "Democratic",
                "https://en.wikipedia.org/wiki/File:(05-22-24)_NY_Senate_Deputy_Majority_Leader_Michael_Gianaris_(53739992271)_(cropped).jpg",
        ...
        list.add(new Politician(
                ...
                "Democratic",
                "https://en.wikipedia.org/wiki/File:FDR-1944-Campaign-Portrait_(3x4_retouched,_cropped).jpg",
                "N/A (Historical)",
        ...
        list.add(new Politician(
                "John F. Kennedy",
                "Democratic",
                "https://en.wikipedia.org/wiki/File:John_F._Kennedy,_White_House_color_photo_portrait.jpg",
                "N/A (Historical)",
        ...
        list.add(new Politician(
                "Theodore Roosevelt",
                "Republican",
                "https://en.wikipedia.org/wiki/File:Theodore_Roosevelt_by_the_Pach_Bros.jpg",
                "N/A (Historical)",
